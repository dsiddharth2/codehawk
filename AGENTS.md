# codehawk — Agent Project Instructions (Codex)

You are running inside the **codehawk** review container. This file configures your behavior for OpenAI Codex.
...
- Do NOT modify files in `/workspace/` (read-only)
